# Generated by Powerlevel10k configuration wizard on 2019-12-21 at 14:11 +07.
...
# darkest, sparse, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  function my_git_formatter() {
    ...
    # If local branch name or tag is at most 40 characters long, show it in full.
    # Otherwise show the first 25 … the last 25.
    (( $#where > 40 )) && where[25,-25]="…"
